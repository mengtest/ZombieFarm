...
public class RagdollBuilders
{
    protected static Transform pelvis;

    protected static Transform leftHips = null;
    protected static Transform leftKnee = null;
    protected static Transform leftFoot = null;

    protected static Transform rightHips = null;
    protected static Transform rightKnee = null;
    protected static Transform rightFoot = null;

    protected static Transform leftArm = null;
    protected static Transform leftElbow = null;

    protected static Transform rightArm = null;
    protected static Transform rightElbow = null;

    protected static Transform middleSpine = null;

    protected static Transform head = null;


    protected static float totalMass = 20;
    ...
    public class RagdollBuilderInfo
    {
    ...
    public static void GenerateRagdall(RagdollBuilderInfo ragdollInfo)
    {
        pelvis = ragdollInfo.pelvis;

        leftHips = ragdollInfo.leftHips;
        leftKnee = ragdollInfo.leftKnee;
        leftFoot = ragdollInfo.leftFoot;

        rightHips = ragdollInfo.rightHips;
        rightKnee = ragdollInfo.rightKnee;
        rightFoot = ragdollInfo.rightFoot;

        leftArm = ragdollInfo.leftArm;
        leftElbow = ragdollInfo.leftElbow;

        rightArm = ragdollInfo.rightArm;
        rightElbow = ragdollInfo.rightElbow;

        middleSpine = ragdollInfo.middleSpine;

        head = ragdollInfo.head;
    ...
    static string CheckConsistency()
    {
        PrepareBones();
    ...
    static BoneInfo FindBone(string name)
    {
        foreach (BoneInfo bone in bones)
        {
            if (bone.name == name)
    ...
    static void AddMirroredJoint(string name, Transform leftAnchor, Transform rightAnchor, string parent, Vector3 worldTwistAxis, Vector3 worldSwingAxis, float minLimit, float maxLimit, float swingLimit, Type colliderType, float radiusScale, float density)
    {
    ...
    static void AddJoint(string name, Transform anchor, string parent, Vector3 worldTwistAxis, Vector3 worldSwingAxis, float minLimit, float maxLimit, float swingLimit, Type colliderType, float radiusScale, float density)
    {
    ...
    static Bounds Clip(Bounds bounds, Transform relativeTo, Transform clipTransform, bool below)
    {
    ...
    static Bounds GetBreastBounds(Transform relativeTo)
    {
        // Pelvis bounds
        Bounds bounds = new Bounds();
    ...
    static void AddBreastColliders()
    {
