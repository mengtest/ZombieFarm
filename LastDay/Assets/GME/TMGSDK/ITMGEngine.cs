...
namespace TencentMobileGaming
{
	...
	public abstract class ITMGContext
	{
		...
		public abstract int EnterRoom(int roomId, ITMGRoomType roomType, byte[] authBuffer);
		public abstract int EnterTeamRoom(int roomId, ITMGRoomType roomType, byte[] authBuffer,int teamId, int audioMode);
