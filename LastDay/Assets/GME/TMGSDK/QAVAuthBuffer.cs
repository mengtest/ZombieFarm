...
namespace TencentMobileGaming
{
	public class QAVAuthBuffer
	{
		...
		public static byte[] GenAuthBuffer(int appId, int roomId, string openId, string key)
		{
			QAVSDKInit.InitSDK();
...
#if UNITY_5_5
        private static extern int QAVSDK_AuthBuffer_GenAuthBuffer(int appId, int authId, [MarshalAs(UnmanagedType.LPStr)] string account,
