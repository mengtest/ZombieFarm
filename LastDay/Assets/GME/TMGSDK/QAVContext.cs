...
namespace TencentMobileGaming
{
	public class QAVContext : ITMGContext
	{
		...
		public override int EnterRoom(int roomId, ITMGRoomType roomtype, byte[] authBuffer)
        {
		...
		public override int EnterTeamRoom(int roomId, ITMGRoomType roomtype, byte[] authBuffer,int teamId, int audioMode)
		{
