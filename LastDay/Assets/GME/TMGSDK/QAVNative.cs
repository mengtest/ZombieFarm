...
namespace TencentMobileGaming
{
	public class QAVNative
	{
		...
		[DllImport(MyLibName, CallingConvention = CallingConvention.Cdecl)]
		public static extern int QAVSDK_AVContext_EnterRoom(IntPtr avcontext, int roomId, [MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 3)] byte[] authBuffer, int authBufferLen,
