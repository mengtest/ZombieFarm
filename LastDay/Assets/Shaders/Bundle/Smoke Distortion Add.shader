    ...
    SubShader {
        ...
        Pass {
            ...
            float4 frag(VertexOutput i, float facing : VFACE) : COLOR {
                ...
                clip(((i.vertexColor.a*(_Texture_var.r-_Strength))+(_Texture_var.r*((_TextureDistort_var.r-_Power)*1.5)*node_1682)) - 0.5);
////// Lighting:
////// Emissive:
                float3 emissive = (_Color.rgb*i.vertexColor.rgb*(3.0*(1.0 - ((_Texture_var.r-_Subtract)+_Texture_var.r+(node_1682*_Texture_var.r)))));
