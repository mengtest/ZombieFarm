    ...
    public class UnityEngineAINavMeshAgentWrap 
    {
        ...
        static int _m_SetDestination(RealStatePtr L)
        {
		    try {
                ...
                {
                    UnityEngine.Vector3 target = UnityEngine_Vector3.ToVector3(L, 2);
        ...
        static int _m_Warp(RealStatePtr L)
        {
		    try {
                ...
                {
                    UnityEngine.Vector3 newPosition = UnityEngine_Vector3.ToVector3(L, 2);
        ...
        static int _m_Move(RealStatePtr L)
        {
		    try {
                ...
                {
                    UnityEngine.Vector3 offset = UnityEngine_Vector3.ToVector3(L, 2);
        ...
        static int _m_Raycast(RealStatePtr L)
        {
		    try {
                ...
                {
                    UnityEngine.Vector3 targetPosition = UnityEngine_Vector3.ToVector3(L, 2);
                    UnityEngine.AI.NavMeshHit hit;
        ...
        static int _g_get_destination(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.AI.NavMeshAgent __cl_gen_to_be_invoked = (UnityEngine.AI.NavMeshAgent)translator.FastGetCSObj(L, 1);
                UnityEngine_Vector3.PushX(L, __cl_gen_to_be_invoked.destination);
            } catch(System.Exception __gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + __gen_e);
            }
            return 1;
        ...
        static int _g_get_nextPosition(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.AI.NavMeshAgent __cl_gen_to_be_invoked = (UnityEngine.AI.NavMeshAgent)translator.FastGetCSObj(L, 1);
                UnityEngine_Vector3.PushX(L, __cl_gen_to_be_invoked.nextPosition);
            } catch(System.Exception __gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + __gen_e);
            }
            return 1;
        ...
        static int _g_get_steeringTarget(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.AI.NavMeshAgent __cl_gen_to_be_invoked = (UnityEngine.AI.NavMeshAgent)translator.FastGetCSObj(L, 1);
                UnityEngine_Vector3.PushX(L, __cl_gen_to_be_invoked.steeringTarget);
            } catch(System.Exception __gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + __gen_e);
            }
            return 1;
        ...
        static int _g_get_desiredVelocity(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.AI.NavMeshAgent __cl_gen_to_be_invoked = (UnityEngine.AI.NavMeshAgent)translator.FastGetCSObj(L, 1);
                UnityEngine_Vector3.PushX(L, __cl_gen_to_be_invoked.desiredVelocity);
            } catch(System.Exception __gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + __gen_e);
            }
            return 1;
        ...
        static int _g_get_pathStatus(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.AI.NavMeshAgent __cl_gen_to_be_invoked = (UnityEngine.AI.NavMeshAgent)translator.FastGetCSObj(L, 1);
                System_Enum.PushX(L, __cl_gen_to_be_invoked.pathStatus);
            } catch(System.Exception __gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + __gen_e);
            }
            return 1;
        ...
        static int _g_get_pathEndPosition(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.AI.NavMeshAgent __cl_gen_to_be_invoked = (UnityEngine.AI.NavMeshAgent)translator.FastGetCSObj(L, 1);
                UnityEngine_Vector3.PushX(L, __cl_gen_to_be_invoked.pathEndPosition);
            } catch(System.Exception __gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + __gen_e);
            }
            return 1;
        ...
        static int _g_get_obstacleAvoidanceType(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.AI.NavMeshAgent __cl_gen_to_be_invoked = (UnityEngine.AI.NavMeshAgent)translator.FastGetCSObj(L, 1);
                System_Enum.PushX(L, __cl_gen_to_be_invoked.obstacleAvoidanceType);
            } catch(System.Exception __gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + __gen_e);
            }
            return 1;
        ...
        static int _s_set_obstacleAvoidanceType(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.AI.NavMeshAgent __cl_gen_to_be_invoked = (UnityEngine.AI.NavMeshAgent)translator.FastGetCSObj(L, 1);
                UnityEngine.AI.ObstacleAvoidanceType __cl_gen_value = (UnityEngine.AI.ObstacleAvoidanceType)System_Enum.ToEnumValue(L, 2, typeof(UnityEngine.AI.ObstacleAvoidanceType));
