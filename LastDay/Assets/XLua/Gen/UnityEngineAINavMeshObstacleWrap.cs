    ...
    public class UnityEngineAINavMeshObstacleWrap 
    {
        ...
        static int _g_get_shape(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.AI.NavMeshObstacle __cl_gen_to_be_invoked = (UnityEngine.AI.NavMeshObstacle)translator.FastGetCSObj(L, 1);
                System_Enum.PushX(L, __cl_gen_to_be_invoked.shape);
            } catch(System.Exception __gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + __gen_e);
            }
            return 1;
        ...
        static int _g_get_center(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.AI.NavMeshObstacle __cl_gen_to_be_invoked = (UnityEngine.AI.NavMeshObstacle)translator.FastGetCSObj(L, 1);
                UnityEngine_Vector3.PushX(L, __cl_gen_to_be_invoked.center);
            } catch(System.Exception __gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + __gen_e);
            }
            return 1;
        ...
        static int _g_get_size(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.AI.NavMeshObstacle __cl_gen_to_be_invoked = (UnityEngine.AI.NavMeshObstacle)translator.FastGetCSObj(L, 1);
                UnityEngine_Vector3.PushX(L, __cl_gen_to_be_invoked.size);
            } catch(System.Exception __gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + __gen_e);
            }
            return 1;
        ...
        static int _s_set_shape(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.AI.NavMeshObstacle __cl_gen_to_be_invoked = (UnityEngine.AI.NavMeshObstacle)translator.FastGetCSObj(L, 1);
                UnityEngine.AI.NavMeshObstacleShape __cl_gen_value = (UnityEngine.AI.NavMeshObstacleShape)System_Enum.ToEnumValue(L, 2, typeof(UnityEngine.AI.NavMeshObstacleShape));
