    ...
    public class UnityEngineApplicationWrap 
    {
        ...
        static int _m_CanStreamedLevelBeLoaded_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                {
                    string levelName = LuaIndexTo.ToLuaString(L, 1);
        ...
        static int _m_OpenURL_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                {
                    string url = LuaIndexTo.ToLuaString(L, 1);
        ...
        static int _m_GetStackTraceLogType_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                {
                    UnityEngine.LogType logType = (UnityEngine.LogType)System_Enum.ToEnumValue(L, 1, typeof(UnityEngine.LogType));
        ...
        static int _m_SetStackTraceLogType_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                {
                    UnityEngine.LogType logType = (UnityEngine.LogType)System_Enum.ToEnumValue(L, 1, typeof(UnityEngine.LogType));
                    UnityEngine.StackTraceLogType stackTraceType = (UnityEngine.StackTraceLogType)System_Enum.ToEnumValue(L, 2, typeof(UnityEngine.StackTraceLogType));
        ...
        static int _m_RequestUserAuthorization_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                {
                    UnityEngine.UserAuthorization mode = (UnityEngine.UserAuthorization)System_Enum.ToEnumValue(L, 1, typeof(UnityEngine.UserAuthorization));
        ...
        static int _g_get_platform(RealStatePtr L)
        {
		    try {
			    ...
			    System_Enum.PushX(L, UnityEngine.Application.platform);
            } catch(System.Exception __gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + __gen_e);
            }
            return 1;
        ...
        static int _g_get_installMode(RealStatePtr L)
        {
		    try {
			    ...
			    System_Enum.PushX(L, UnityEngine.Application.installMode);
            } catch(System.Exception __gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + __gen_e);
            }
            return 1;
        ...
        static int _g_get_sandboxType(RealStatePtr L)
        {
		    try {
			    ...
			    System_Enum.PushX(L, UnityEngine.Application.sandboxType);
            } catch(System.Exception __gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + __gen_e);
            }
            return 1;
        ...
        static int _g_get_systemLanguage(RealStatePtr L)
        {
		    try {
			    ...
			    System_Enum.PushX(L, UnityEngine.Application.systemLanguage);
            } catch(System.Exception __gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + __gen_e);
            }
            return 1;
        ...
        static int _g_get_backgroundLoadingPriority(RealStatePtr L)
        {
		    try {
			    ...
			    System_Enum.PushX(L, UnityEngine.Application.backgroundLoadingPriority);
            } catch(System.Exception __gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + __gen_e);
            }
            return 1;
        ...
        static int _g_get_internetReachability(RealStatePtr L)
        {
		    try {
			    ...
			    System_Enum.PushX(L, UnityEngine.Application.internetReachability);
            } catch(System.Exception __gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + __gen_e);
            }
            return 1;
        ...
        static int _s_set_backgroundLoadingPriority(RealStatePtr L)
        {
			...
			UnityEngine.ThreadPriority __cl_gen_value = (UnityEngine.ThreadPriority)System_Enum.ToEnumValue(L, 1, typeof(UnityEngine.ThreadPriority));
        ...
        static int _e_wantsToQuit(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			    int __gen_param_count = LuaAPI.lua_gettop(L);
                System.Func<bool> __gen_delegate = translator.GetDelegate<System.Func<bool>>(L, 2);
                if (__gen_delegate == null) {
				...
				if (__gen_param_count == 2 && LuaAPI.xlua_is_eq_str(L, 1, "+")) {
					UnityEngine.Application.wantsToQuit += __gen_delegate;
					return 0;
				} 
        ...
        static int _e_quitting(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			    int __gen_param_count = LuaAPI.lua_gettop(L);
                System.Action __gen_delegate = translator.GetDelegate<System.Action>(L, 2);
                if (__gen_delegate == null) {
				...
				if (__gen_param_count == 2 && LuaAPI.xlua_is_eq_str(L, 1, "+")) {
					UnityEngine.Application.quitting += __gen_delegate;
					return 0;
				} 
