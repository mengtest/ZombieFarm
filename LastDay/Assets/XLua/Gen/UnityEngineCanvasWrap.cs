    ...
    public class UnityEngineCanvasWrap 
    {
        ...
        static int _g_get_renderMode(RealStatePtr L)
        {
		    try {
                ...
                System_Enum.PushX(L, __cl_gen_to_be_invoked.renderMode);
            } catch(System.Exception __gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + __gen_e);
            }
            return 1;
        ...
        static int _g_get_additionalShaderChannels(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.Canvas __cl_gen_to_be_invoked = (UnityEngine.Canvas)translator.FastGetCSObj(L, 1);
                System_Enum.PushX(L, __cl_gen_to_be_invoked.additionalShaderChannels);
            } catch(System.Exception __gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + __gen_e);
            }
            return 1;
        ...
        static int _s_set_renderMode(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.Canvas __cl_gen_to_be_invoked = (UnityEngine.Canvas)translator.FastGetCSObj(L, 1);
                UnityEngine.RenderMode __cl_gen_value = (UnityEngine.RenderMode)System_Enum.ToEnumValue(L, 2, typeof(UnityEngine.RenderMode));
        ...
        static int _s_set_additionalShaderChannels(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.Canvas __cl_gen_to_be_invoked = (UnityEngine.Canvas)translator.FastGetCSObj(L, 1);
                UnityEngine.AdditionalCanvasShaderChannels __cl_gen_value = (UnityEngine.AdditionalCanvasShaderChannels)System_Enum.ToEnumValue(L, 2, typeof(UnityEngine.AdditionalCanvasShaderChannels));
