    ...
    public class UnityEngineEventSystemsPointerEventDataWrap 
    {
        ...
        static int _g_get_position(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.EventSystems.PointerEventData __cl_gen_to_be_invoked = (UnityEngine.EventSystems.PointerEventData)translator.FastGetCSObj(L, 1);
                UnityEngine_Vector2.PushX(L, __cl_gen_to_be_invoked.position);
            } catch(System.Exception __gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + __gen_e);
            }
            return 1;
        ...
        static int _g_get_delta(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.EventSystems.PointerEventData __cl_gen_to_be_invoked = (UnityEngine.EventSystems.PointerEventData)translator.FastGetCSObj(L, 1);
                UnityEngine_Vector2.PushX(L, __cl_gen_to_be_invoked.delta);
            } catch(System.Exception __gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + __gen_e);
            }
            return 1;
        ...
        static int _g_get_pressPosition(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.EventSystems.PointerEventData __cl_gen_to_be_invoked = (UnityEngine.EventSystems.PointerEventData)translator.FastGetCSObj(L, 1);
                UnityEngine_Vector2.PushX(L, __cl_gen_to_be_invoked.pressPosition);
            } catch(System.Exception __gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + __gen_e);
            }
            return 1;
        ...
        static int _g_get_scrollDelta(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.EventSystems.PointerEventData __cl_gen_to_be_invoked = (UnityEngine.EventSystems.PointerEventData)translator.FastGetCSObj(L, 1);
                UnityEngine_Vector2.PushX(L, __cl_gen_to_be_invoked.scrollDelta);
            } catch(System.Exception __gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + __gen_e);
            }
            return 1;
        ...
        static int _g_get_button(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.EventSystems.PointerEventData __cl_gen_to_be_invoked = (UnityEngine.EventSystems.PointerEventData)translator.FastGetCSObj(L, 1);
                System_Enum.PushX(L, __cl_gen_to_be_invoked.button);
            } catch(System.Exception __gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + __gen_e);
            }
            return 1;
        ...
        static int _s_set_button(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.EventSystems.PointerEventData __cl_gen_to_be_invoked = (UnityEngine.EventSystems.PointerEventData)translator.FastGetCSObj(L, 1);
                UnityEngine.EventSystems.PointerEventData.InputButton __cl_gen_value = (UnityEngine.EventSystems.PointerEventData.InputButton)System_Enum.ToEnumValue(L, 2, typeof(UnityEngine.EventSystems.PointerEventData.InputButton));
