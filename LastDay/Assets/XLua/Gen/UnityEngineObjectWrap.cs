    ...
    public class UnityEngineObjectWrap 
    {
        ...
        static int _m_Instantiate_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                if(__gen_param_count == 3&& translator.Assignable<UnityEngine.Object>(L, 1)&& UnityEngine_Vector3.IsVector3(L, 2)&& UnityEngine_Quaternion.IsQuaternion(L, 3)) 
                {
                    UnityEngine.Object original = (UnityEngine.Object)translator.GetObject(L, 1, typeof(UnityEngine.Object));
                ...
                if(__gen_param_count == 4&& translator.Assignable<UnityEngine.Object>(L, 1)&& UnityEngine_Vector3.IsVector3(L, 2)&& UnityEngine_Quaternion.IsQuaternion(L, 3)&& translator.Assignable<UnityEngine.Transform>(L, 4)) 
                {
                    UnityEngine.Object original = (UnityEngine.Object)translator.GetObject(L, 1, typeof(UnityEngine.Object));
                    UnityEngine.Vector3 position = UnityEngine_Vector3.ToVector3(L, 2);
                    UnityEngine.Quaternion rotation = UnityEngine_Quaternion.ToQuaternion(L, 3);
        ...
        static int _g_get_hideFlags(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.Object __cl_gen_to_be_invoked = (UnityEngine.Object)translator.FastGetCSObj(L, 1);
                System_Enum.PushX(L, __cl_gen_to_be_invoked.hideFlags);
            } catch(System.Exception __gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + __gen_e);
            }
            return 1;
        ...
        static int _s_set_name(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.Object __cl_gen_to_be_invoked = (UnityEngine.Object)translator.FastGetCSObj(L, 1);
                __cl_gen_to_be_invoked.name = LuaIndexTo.ToLuaString(L, 2);
        ...
        static int _s_set_hideFlags(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.Object __cl_gen_to_be_invoked = (UnityEngine.Object)translator.FastGetCSObj(L, 1);
                UnityEngine.HideFlags __cl_gen_value = (UnityEngine.HideFlags)System_Enum.ToEnumValue(L, 2, typeof(UnityEngine.HideFlags));
