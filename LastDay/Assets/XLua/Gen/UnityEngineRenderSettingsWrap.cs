    ...
    public class UnityEngineRenderSettingsWrap 
    {
        ...
        static int _g_get_fogMode(RealStatePtr L)
        {
		    try {
			    ...
			    System_Enum.PushX(L, UnityEngine.RenderSettings.fogMode);
            } catch(System.Exception __gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + __gen_e);
            }
            return 1;
        ...
        static int _g_get_fogColor(RealStatePtr L)
        {
		    try {
			    ...
			    UnityEngine_Color.PushX(L, UnityEngine.RenderSettings.fogColor);
            } catch(System.Exception __gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + __gen_e);
            }
            return 1;
        ...
        static int _g_get_ambientMode(RealStatePtr L)
        {
		    try {
			    ...
			    System_Enum.PushX(L, UnityEngine.RenderSettings.ambientMode);
            } catch(System.Exception __gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + __gen_e);
            }
            return 1;
        ...
        static int _g_get_ambientSkyColor(RealStatePtr L)
        {
		    try {
			    ...
			    UnityEngine_Color.PushX(L, UnityEngine.RenderSettings.ambientSkyColor);
            } catch(System.Exception __gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + __gen_e);
            }
            return 1;
        ...
        static int _g_get_ambientEquatorColor(RealStatePtr L)
        {
		    try {
			    ...
			    UnityEngine_Color.PushX(L, UnityEngine.RenderSettings.ambientEquatorColor);
            } catch(System.Exception __gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + __gen_e);
            }
            return 1;
        ...
        static int _g_get_ambientGroundColor(RealStatePtr L)
        {
		    try {
			    ...
			    UnityEngine_Color.PushX(L, UnityEngine.RenderSettings.ambientGroundColor);
            } catch(System.Exception __gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + __gen_e);
            }
            return 1;
        ...
        static int _g_get_ambientLight(RealStatePtr L)
        {
		    try {
			    ...
			    UnityEngine_Color.PushX(L, UnityEngine.RenderSettings.ambientLight);
            } catch(System.Exception __gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + __gen_e);
            }
            return 1;
        ...
        static int _g_get_subtractiveShadowColor(RealStatePtr L)
        {
		    try {
			    ...
			    UnityEngine_Color.PushX(L, UnityEngine.RenderSettings.subtractiveShadowColor);
            } catch(System.Exception __gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + __gen_e);
            }
            return 1;
        ...
        static int _g_get_defaultReflectionMode(RealStatePtr L)
        {
		    try {
			    ...
			    System_Enum.PushX(L, UnityEngine.RenderSettings.defaultReflectionMode);
            } catch(System.Exception __gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + __gen_e);
            }
            return 1;
        ...
        static int _s_set_fogMode(RealStatePtr L)
        {
			...
			UnityEngine.FogMode __cl_gen_value = (UnityEngine.FogMode)System_Enum.ToEnumValue(L, 1, typeof(UnityEngine.FogMode));
        ...
        static int _s_set_fogColor(RealStatePtr L)
        {
			...
			UnityEngine.Color __cl_gen_value = UnityEngine_Color.ToColor(L, 1);
        ...
        static int _s_set_ambientMode(RealStatePtr L)
        {
			...
			UnityEngine.Rendering.AmbientMode __cl_gen_value = (UnityEngine.Rendering.AmbientMode)System_Enum.ToEnumValue(L, 1, typeof(UnityEngine.Rendering.AmbientMode));
        ...
        static int _s_set_defaultReflectionMode(RealStatePtr L)
        {
			...
			UnityEngine.Rendering.DefaultReflectionMode __cl_gen_value = (UnityEngine.Rendering.DefaultReflectionMode)System_Enum.ToEnumValue(L, 1, typeof(UnityEngine.Rendering.DefaultReflectionMode));
