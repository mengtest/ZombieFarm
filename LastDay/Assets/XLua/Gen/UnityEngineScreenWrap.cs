    ...
    public class UnityEngineScreenWrap 
    {
        ...
        static int _m_SetResolution_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                if(__gen_param_count == 3&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 1)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2)&& translator.Assignable<UnityEngine.FullScreenMode>(L, 3)) 
                {
                    int width = LuaAPI.xlua_tointeger(L, 1);
                    int height = LuaAPI.xlua_tointeger(L, 2);
                    UnityEngine.FullScreenMode fullscreenMode = (UnityEngine.FullScreenMode)System_Enum.ToEnumValue(L, 3, typeof(UnityEngine.FullScreenMode));
                ...
                if(__gen_param_count == 4&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 1)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2)&& translator.Assignable<UnityEngine.FullScreenMode>(L, 3)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 4)) 
                {
                    int width = LuaAPI.xlua_tointeger(L, 1);
                    int height = LuaAPI.xlua_tointeger(L, 2);
                    UnityEngine.FullScreenMode fullscreenMode = (UnityEngine.FullScreenMode)System_Enum.ToEnumValue(L, 3, typeof(UnityEngine.FullScreenMode));
        ...
        static int _g_get_orientation(RealStatePtr L)
        {
		    try {
			    ...
			    System_Enum.PushX(L, UnityEngine.Screen.orientation);
            } catch(System.Exception __gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + __gen_e);
            }
            return 1;
        ...
        static int _g_get_fullScreenMode(RealStatePtr L)
        {
		    try {
			    ...
			    System_Enum.PushX(L, UnityEngine.Screen.fullScreenMode);
            } catch(System.Exception __gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + __gen_e);
            }
            return 1;
        ...
        static int _s_set_orientation(RealStatePtr L)
        {
			...
			UnityEngine.ScreenOrientation __cl_gen_value = (UnityEngine.ScreenOrientation)System_Enum.ToEnumValue(L, 1, typeof(UnityEngine.ScreenOrientation));
        ...
        static int _s_set_fullScreenMode(RealStatePtr L)
        {
			...
			UnityEngine.FullScreenMode __cl_gen_value = (UnityEngine.FullScreenMode)System_Enum.ToEnumValue(L, 1, typeof(UnityEngine.FullScreenMode));
				UnityEngine.Screen.fullScreenMode = __cl_gen_value;
