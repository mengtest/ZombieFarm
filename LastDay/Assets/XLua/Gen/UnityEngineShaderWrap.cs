    ...
    public class UnityEngineShaderWrap 
    {
        ...
        static int _m_EnableKeyword_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                {
                    string keyword = LuaIndexTo.ToLuaString(L, 1);
        ...
        static int _m_SetGlobalVector_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                if(__gen_param_count == 2&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 1)&& UnityEngine_Vector4.IsVector4(L, 2)) 
                {
                    int nameID = LuaAPI.xlua_tointeger(L, 1);
                    UnityEngine.Vector4 value = UnityEngine_Vector4.ToVector4(L, 2);
                ...
                if(__gen_param_count == 2&& (LuaAPI.lua_isnil(L, 1) || LuaAPI.lua_type(L, 1) == LuaTypes.LUA_TSTRING)&& UnityEngine_Vector4.IsVector4(L, 2)) 
                {
                    string name = LuaIndexTo.ToLuaString(L, 1);
                    UnityEngine.Vector4 value = UnityEngine_Vector4.ToVector4(L, 2);
        ...
        static int _m_SetGlobalColor_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                if(__gen_param_count == 2&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 1)&& UnityEngine_Color.IsColor(L, 2)) 
                {
                    int nameID = LuaAPI.xlua_tointeger(L, 1);
                    UnityEngine.Color value = UnityEngine_Color.ToColor(L, 2);
                ...
                if(__gen_param_count == 2&& (LuaAPI.lua_isnil(L, 1) || LuaAPI.lua_type(L, 1) == LuaTypes.LUA_TSTRING)&& UnityEngine_Color.IsColor(L, 2)) 
                {
                    string name = LuaIndexTo.ToLuaString(L, 1);
                    UnityEngine.Color value = UnityEngine_Color.ToColor(L, 2);
        ...
        static int _m_SetGlobalBuffer_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                {
                    int nameID = LuaAPI.xlua_tointeger(L, 1);
                    UnityEngine.ComputeBuffer value = (UnityEngine.ComputeBuffer)translator.GetObject(L, 2, typeof(UnityEngine.ComputeBuffer));
        ...
        static int _s_set_globalRenderPipeline(RealStatePtr L)
        {
		    try {
			    ...
			    UnityEngine.Shader.globalRenderPipeline = LuaIndexTo.ToLuaString(L, 1);
