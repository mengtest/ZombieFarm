    ...
    public class UnityEngineSystemInfoWrap 
    {
        ...
        static int _m_SupportsRenderTextureFormat_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                {
                    UnityEngine.RenderTextureFormat format = (UnityEngine.RenderTextureFormat)System_Enum.ToEnumValue(L, 1, typeof(UnityEngine.RenderTextureFormat));
        ...
        static int _m_SupportsTextureFormat_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                {
                    UnityEngine.TextureFormat format = (UnityEngine.TextureFormat)System_Enum.ToEnumValue(L, 1, typeof(UnityEngine.TextureFormat));
        ...
        static int _m_IsFormatSupported_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                {
                    UnityEngine.Experimental.Rendering.GraphicsFormat format = (UnityEngine.Experimental.Rendering.GraphicsFormat)System_Enum.ToEnumValue(L, 1, typeof(UnityEngine.Experimental.Rendering.GraphicsFormat));
                    UnityEngine.Experimental.Rendering.FormatUsage usage = (UnityEngine.Experimental.Rendering.FormatUsage)System_Enum.ToEnumValue(L, 2, typeof(UnityEngine.Experimental.Rendering.FormatUsage));
                    
                        bool __cl_gen_ret = UnityEngine.SystemInfo.IsFormatSupported( format, usage );
                        LuaAPI.lua_pushboolean(L, __cl_gen_ret);
        ...
        static int _g_get_batteryStatus(RealStatePtr L)
        {
		    try {
			    ...
			    System_Enum.PushX(L, UnityEngine.SystemInfo.batteryStatus);
            } catch(System.Exception __gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + __gen_e);
            }
            return 1;
        ...
        static int _g_get_operatingSystemFamily(RealStatePtr L)
        {
		    try {
			    ...
			    System_Enum.PushX(L, UnityEngine.SystemInfo.operatingSystemFamily);
            } catch(System.Exception __gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + __gen_e);
            }
            return 1;
        ...
        static int _g_get_deviceType(RealStatePtr L)
        {
		    try {
			    ...
			    System_Enum.PushX(L, UnityEngine.SystemInfo.deviceType);
            } catch(System.Exception __gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + __gen_e);
            }
            return 1;
        ...
        static int _g_get_graphicsDeviceType(RealStatePtr L)
        {
		    try {
			    ...
			    System_Enum.PushX(L, UnityEngine.SystemInfo.graphicsDeviceType);
            } catch(System.Exception __gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + __gen_e);
            }
            return 1;
        ...
        static int _g_get_copyTextureSupport(RealStatePtr L)
        {
		    try {
			    ...
			    System_Enum.PushX(L, UnityEngine.SystemInfo.copyTextureSupport);
            } catch(System.Exception __gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + __gen_e);
            }
            return 1;
        ...
        static int _g_get_npotSupport(RealStatePtr L)
        {
		    try {
			    ...
			    System_Enum.PushX(L, UnityEngine.SystemInfo.npotSupport);
            } catch(System.Exception __gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + __gen_e);
            }
            return 1;
