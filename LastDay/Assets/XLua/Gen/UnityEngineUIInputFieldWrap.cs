    ...
    public class UnityEngineUIInputFieldWrap 
    {
        ...
        static int _g_get_touchScreenKeyboard(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.UI.InputField __cl_gen_to_be_invoked = (UnityEngine.UI.InputField)translator.FastGetCSObj(L, 1);
                translator.Push(L, __cl_gen_to_be_invoked.touchScreenKeyboard);
            } catch(System.Exception __gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + __gen_e);
            }
            return 1;
        ...
        static int _s_set_contentType(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.UI.InputField __cl_gen_to_be_invoked = (UnityEngine.UI.InputField)translator.FastGetCSObj(L, 1);
                UnityEngine.UI.InputField.ContentType __cl_gen_value = (UnityEngine.UI.InputField.ContentType)System_Enum.ToEnumValue(L, 2, typeof(UnityEngine.UI.InputField.ContentType));
        ...
        static int _s_set_lineType(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.UI.InputField __cl_gen_to_be_invoked = (UnityEngine.UI.InputField)translator.FastGetCSObj(L, 1);
                UnityEngine.UI.InputField.LineType __cl_gen_value = (UnityEngine.UI.InputField.LineType)System_Enum.ToEnumValue(L, 2, typeof(UnityEngine.UI.InputField.LineType));
        ...
        static int _s_set_inputType(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.UI.InputField __cl_gen_to_be_invoked = (UnityEngine.UI.InputField)translator.FastGetCSObj(L, 1);
                UnityEngine.UI.InputField.InputType __cl_gen_value = (UnityEngine.UI.InputField.InputType)System_Enum.ToEnumValue(L, 2, typeof(UnityEngine.UI.InputField.InputType));
        ...
        static int _s_set_characterValidation(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.UI.InputField __cl_gen_to_be_invoked = (UnityEngine.UI.InputField)translator.FastGetCSObj(L, 1);
                UnityEngine.UI.InputField.CharacterValidation __cl_gen_value = (UnityEngine.UI.InputField.CharacterValidation)System_Enum.ToEnumValue(L, 2, typeof(UnityEngine.UI.InputField.CharacterValidation));
