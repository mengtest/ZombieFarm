    ...
    public class UnityEngineUIScrollRectWrap 
    {
        ...
        static int _m_Rebuild(RealStatePtr L)
        {
		    try {
                ...
                {
                    UnityEngine.UI.CanvasUpdate executing = (UnityEngine.UI.CanvasUpdate)System_Enum.ToEnumValue(L, 2, typeof(UnityEngine.UI.CanvasUpdate));
        ...
        static int _g_get_movementType(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.UI.ScrollRect __cl_gen_to_be_invoked = (UnityEngine.UI.ScrollRect)translator.FastGetCSObj(L, 1);
                System_Enum.PushX(L, __cl_gen_to_be_invoked.movementType);
            } catch(System.Exception __gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + __gen_e);
            }
            return 1;
        ...
        static int _g_get_horizontalScrollbarVisibility(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.UI.ScrollRect __cl_gen_to_be_invoked = (UnityEngine.UI.ScrollRect)translator.FastGetCSObj(L, 1);
                System_Enum.PushX(L, __cl_gen_to_be_invoked.horizontalScrollbarVisibility);
            } catch(System.Exception __gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + __gen_e);
            }
            return 1;
        ...
        static int _g_get_verticalScrollbarVisibility(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.UI.ScrollRect __cl_gen_to_be_invoked = (UnityEngine.UI.ScrollRect)translator.FastGetCSObj(L, 1);
                System_Enum.PushX(L, __cl_gen_to_be_invoked.verticalScrollbarVisibility);
            } catch(System.Exception __gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + __gen_e);
            }
            return 1;
        ...
        static int _g_get_velocity(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.UI.ScrollRect __cl_gen_to_be_invoked = (UnityEngine.UI.ScrollRect)translator.FastGetCSObj(L, 1);
                UnityEngine_Vector2.PushX(L, __cl_gen_to_be_invoked.velocity);
            } catch(System.Exception __gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + __gen_e);
            }
            return 1;
        ...
        static int _g_get_normalizedPosition(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.UI.ScrollRect __cl_gen_to_be_invoked = (UnityEngine.UI.ScrollRect)translator.FastGetCSObj(L, 1);
                UnityEngine_Vector2.PushX(L, __cl_gen_to_be_invoked.normalizedPosition);
            } catch(System.Exception __gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + __gen_e);
            }
            return 1;
        ...
        static int _s_set_movementType(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.UI.ScrollRect __cl_gen_to_be_invoked = (UnityEngine.UI.ScrollRect)translator.FastGetCSObj(L, 1);
                UnityEngine.UI.ScrollRect.MovementType __cl_gen_value = (UnityEngine.UI.ScrollRect.MovementType)System_Enum.ToEnumValue(L, 2, typeof(UnityEngine.UI.ScrollRect.MovementType));
        ...
        static int _s_set_horizontalScrollbarVisibility(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.UI.ScrollRect __cl_gen_to_be_invoked = (UnityEngine.UI.ScrollRect)translator.FastGetCSObj(L, 1);
                UnityEngine.UI.ScrollRect.ScrollbarVisibility __cl_gen_value = (UnityEngine.UI.ScrollRect.ScrollbarVisibility)System_Enum.ToEnumValue(L, 2, typeof(UnityEngine.UI.ScrollRect.ScrollbarVisibility));
