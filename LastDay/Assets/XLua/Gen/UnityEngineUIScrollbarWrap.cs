...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineUIScrollbarWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(type, L, translator, 0, 14, 6, 6);
        ...
        static int _m_SetDirection(RealStatePtr L)
        {
		    try {
                ...
                {
                    UnityEngine.UI.Scrollbar.Direction direction = (UnityEngine.UI.Scrollbar.Direction)System_Enum.ToEnumValue(L, 2, typeof(UnityEngine.UI.Scrollbar.Direction));
        ...
        static int _s_set_direction(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.UI.Scrollbar __cl_gen_to_be_invoked = (UnityEngine.UI.Scrollbar)translator.FastGetCSObj(L, 1);
                UnityEngine.UI.Scrollbar.Direction __cl_gen_value = (UnityEngine.UI.Scrollbar.Direction)System_Enum.ToEnumValue(L, 2, typeof(UnityEngine.UI.Scrollbar.Direction));
