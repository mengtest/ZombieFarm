    ...
    public class UnityEngineUISelectableWrap 
    {
        ...
        static int _m_FindSelectable(RealStatePtr L)
        {
		    try {
                ...
                {
                    UnityEngine.Vector3 dir = UnityEngine_Vector3.ToVector3(L, 2);
        ...
        static int _g_get_transition(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.UI.Selectable __cl_gen_to_be_invoked = (UnityEngine.UI.Selectable)translator.FastGetCSObj(L, 1);
                System_Enum.PushX(L, __cl_gen_to_be_invoked.transition);
            } catch(System.Exception __gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + __gen_e);
            }
            return 1;
        ...
        static int _s_set_transition(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.UI.Selectable __cl_gen_to_be_invoked = (UnityEngine.UI.Selectable)translator.FastGetCSObj(L, 1);
                UnityEngine.UI.Selectable.Transition __cl_gen_value = (UnityEngine.UI.Selectable.Transition)System_Enum.ToEnumValue(L, 2, typeof(UnityEngine.UI.Selectable.Transition));
