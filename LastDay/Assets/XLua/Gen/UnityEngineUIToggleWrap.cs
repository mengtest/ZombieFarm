    ...
    public class UnityEngineUIToggleWrap 
    {
        ...
        static int _g_get_toggleTransition(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.UI.Toggle __cl_gen_to_be_invoked = (UnityEngine.UI.Toggle)translator.FastGetCSObj(L, 1);
                System_Enum.PushX(L, __cl_gen_to_be_invoked.toggleTransition);
            } catch(System.Exception __gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + __gen_e);
            }
            return 1;
        ...
        static int _s_set_toggleTransition(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.UI.Toggle __cl_gen_to_be_invoked = (UnityEngine.UI.Toggle)translator.FastGetCSObj(L, 1);
                UnityEngine.UI.Toggle.ToggleTransition __cl_gen_value = (UnityEngine.UI.Toggle.ToggleTransition)System_Enum.ToEnumValue(L, 2, typeof(UnityEngine.UI.Toggle.ToggleTransition));
