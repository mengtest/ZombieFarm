    ...
    public class UnityEngineWWWWrap 
    {
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				{
					string url = LuaIndexTo.ToLuaString(L, 2);
        ...
        static int _m_EscapeURL_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                {
                    string s = LuaIndexTo.ToLuaString(L, 1);
        ...
        static int _m_GetAudioClip(RealStatePtr L)
        {
		    try {
                ...
                if(__gen_param_count == 4&& LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 2)&& LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 3)&& translator.Assignable<UnityEngine.AudioType>(L, 4)) 
                {
                    bool threeD = LuaAPI.lua_toboolean(L, 2);
                    bool stream = LuaAPI.lua_toboolean(L, 3);
                    UnityEngine.AudioType audioType = (UnityEngine.AudioType)System_Enum.ToEnumValue(L, 4, typeof(UnityEngine.AudioType));
        ...
        static int _m_GetAudioClipCompressed(RealStatePtr L)
        {
		    try {
                ...
                {
                    bool threeD = LuaAPI.lua_toboolean(L, 2);
                    UnityEngine.AudioType audioType = (UnityEngine.AudioType)System_Enum.ToEnumValue(L, 3, typeof(UnityEngine.AudioType));
        ...
        static int _g_get_threadPriority(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.WWW __cl_gen_to_be_invoked = (UnityEngine.WWW)translator.FastGetCSObj(L, 1);
                System_Enum.PushX(L, __cl_gen_to_be_invoked.threadPriority);
            } catch(System.Exception __gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + __gen_e);
            }
            return 1;
        ...
        static int _s_set_threadPriority(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.WWW __cl_gen_to_be_invoked = (UnityEngine.WWW)translator.FastGetCSObj(L, 1);
                UnityEngine.ThreadPriority __cl_gen_value = (UnityEngine.ThreadPriority)System_Enum.ToEnumValue(L, 2, typeof(UnityEngine.ThreadPriority));
