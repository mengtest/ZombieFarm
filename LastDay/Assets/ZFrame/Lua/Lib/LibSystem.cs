...
public static class LibSystem
{
...
#elif UNITY_ANDROID
        try {
			macAddr = SDKManager.Instance.plat.CallR<string>("com.rongygame.util", "GetMacAddress");
        } catch { }
#endif
    ...
    private static int SysCall(ILuaState lua)
    {
        ...
        lua.PushString(SDKManager.Instance.plat.CallR<string>(className, methodName, paramStr));
