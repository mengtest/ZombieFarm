...
public class LogMgr : MonoSingleton<LogMgr>
{
    ...
    public static void Log(LogLevel l, string format, params object[] Args)
    {
        if (logLevel <= l) {
            switch (l) {
                case LogLevel.E: UnityEngine.Debug.LogErrorFormat(format, Args); break;
                case LogLevel.W: UnityEngine.Debug.LogWarningFormat(format, Args); break;
                case LogLevel.D: UnityEngine.Debug.LogFormat(format, Args); break;
                default: UnityEngine.Debug.LogFormat(PROMPT, l, string.Format(format, Args)); break;
            }
        }
    }
