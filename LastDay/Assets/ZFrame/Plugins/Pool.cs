...
namespace ZFrame
{
    ...
    public class ObjPool<T> : PoolBase<T> where T : Object
    {
        ...
        public override string info {
            get { return string.Format("<{0}>: {1}/{2}", m_Obj, countActive, countAll); }
        }
    }
    ...
    public static class ListPool<T>
    {
        ...
        public static string info {
            get { return string.Format("List<{0}>: {1}/{2}", typeof(T).Name, s_ListPool.countActive, s_ListPool.countAll); }
        }
    }
}
