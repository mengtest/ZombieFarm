...
public static class GoTools
{
    ...
    public static GameObject NewChild(GameObject parent, GameObject prefab = null)
	{
		...
		if (go) {
            ...
            AssetsMgr.AssignEditorShaders(go);
		}
		return go;
	}
    ...
    {
        return NewChild(parent, AssetsMgr.A.Load<GameObject>(path));
    }
    ...
    {
        return AddChild(parent, AssetsMgr.A.Load<GameObject>(path), scenely);
    }
