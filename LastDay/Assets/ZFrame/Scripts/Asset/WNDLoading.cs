...
public class WNDLoading : MonoSingleton<WNDLoading>, IAssetProgress, IPoolable
{
    ...
    AsyncOperation asynOpt;
    bool asynOpt_state = true;
    ...
    IEnumerator Start()
    {
        ...
        asynOpt = Loader.LoadLevelAsync(scenePath);
        asynOpt.allowSceneActivation = asynOpt_state;
    ...
    public void AllowLoadScene(bool state)
    {
        asynOpt_state = state;
        if (asynOpt != null) {
            asynOpt.allowSceneActivation = state;
        }
    }
