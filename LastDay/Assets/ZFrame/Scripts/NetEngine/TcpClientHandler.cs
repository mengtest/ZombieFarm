...
namespace ZFrame.NetEngine
{
    ...
    {   
        ...
        [XLua.CSharpCallLua]
        public delegate void TcpClientMsgEvent(TcpClientHandler tcp, INetMsg nm, bool read);
        ...
        public TcpClientMsgEvent doRecieving;
        private TcpClientMsgEvent m_Callback;
        ...
        [NoToLua]
        public void RecieveAll(TcpClientMsgEvent callback)
        {
            m_Callback = callback ?? doRecieving;
        ...
        private void _UnapckNetMsgs(NetMsg nm)
        {
            ...
            try {
                ...
                m_Callback.Invoke(this, nm, read);
