...
namespace ZFrame.UGUI
{
    ...
    public class UISpriteEditor : ImageEditor
    {
        ...
        private static SpriteAtlas FindAtlas(string bundleName, string atlasName)
        {
        ...
        private void AtlasGUI()
        {
            ...
            if (GUILayout.Button("SpriteAtlas", EditorStyles.miniButtonLeft, GUILayout.Width(60))) {
                EditorGUIUtility.ShowObjectPicker<SpriteAtlas>(self.atlas, false, string.Empty, 101);   
            }

            if (GUILayout.Button("UIAtlas", EditorStyles.miniButtonRight, GUILayout.Width(60))) {
                EditorGUIUtility.ShowObjectPicker<UIAtlas>(null, false, string.Empty, 102);
            }
