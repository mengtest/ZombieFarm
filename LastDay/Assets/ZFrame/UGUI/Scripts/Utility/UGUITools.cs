...
namespace ZFrame.UGUI
{
    public static class UGUITools
    {
        ...
        public static Font lastSelectedFont {
            ...
            get {
                if (m_selectedFont == null) {
                    var font = AssetDatabase.LoadAssetAtPath("Assets/Artwork/Fonts/MainFont.TTF", typeof(Font)) as Font;
                    m_selectedFont = font;
                }
        ...
        /// 计算锚点对齐位置
        /// </summary>
        public static Vector2 AnchorPosition(this Camera camera, RectTransform from, Vector2 pivotFrom, RectTransform to, Vector2 pivotTo, Vector2 offset)
        {
            // 源的锚点必须为中心
        ...
        public static void PlayUISfx(string sfxName, string defaultSfx)
        {
#if FMOD
            if (string.IsNullOrEmpty(sfxName)) {
                sfxName = defaultSfx;
            } else if (string.CompareOrdinal(sfxName, "_") == 0) {
                return;
            }
            FMODUnity.FMODMgr.PlayEvent(sfxName, UIManager.Instance.transform);
#else
            if (AudioManager.Instance) {
                ...
                AudioManager.Instance.Play(sfx, "Sfx2D");
            }
#endif
        }
    }
